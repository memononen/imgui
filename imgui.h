...
struct ImDrawList
{
    ...
    IMGUI_API void  AddHorizontalLine(float min_x, float max_x, float y, ImU32 col, float thickness = 1.0f);
    IMGUI_API void  AddVerticalLine(float x, float min_y, float max_y, ImU32 col, float thickness = 1.0f);
